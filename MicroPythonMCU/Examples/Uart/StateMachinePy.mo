...
model StateMachinePy "Appareil série dont le comportement est décrit par un script Python à machine d'état : sa réponse dépend de ce qui s'est passé avant"
...
<p>Un appareil série dont le comportement n'est pas une table mais un <strong>script Python</strong> : <code>appareil.comportement = Script</code>, et <code>scriptPath</code> désigne <code>Device/state_machine.py</code>.</p>
